...
def process_for_marginal(param_set, df):
    ...
    assert param_set.design_matrix_re.shape[1] == param_set.re_var_diag_matrix.shape[0]
    ...
    # combining constraint matrix from betas and gammas
